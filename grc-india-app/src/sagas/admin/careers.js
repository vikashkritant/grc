...
export const fetch_list = function* (action) {
    ...
    try {
        ...
        yield put({
            type: API.CAREERS.LIST.FULLFILLED,
        ...
        yield put({
            type: API.CAREERS.LIST.REJECTED,
...
export const fetch_add = function* (action) {
    ...
    try {
        ...
        yield put({
            type: API.CAREERS.ADD.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
...
export const fetch_details = function* (action) {
    yield put({
        type: API.CAREERS.DETAILS.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        let response = yield reqToAPI({
            url: `${API.CAREERS.DETAILS.URL}/${action.payload.id}`,
            method: "get",
            responseType: 'json',
            headers: {
                "content-type": "application/json",
        ...
        yield put({
            type: API.CAREERS.DETAILS.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.CAREERS.DETAILS.REJECTED,
            payload: errorObject.data
        });
    }
};
...
export const fetch_update = function* (action) {
    yield put({
        type: API.CAREERS.UPDATE.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        yield put({
            type: API.CAREERS.UPDATE.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.CAREERS.UPDATE.REJECTED,
            payload: errorObject.data
        });
    }
};
...
export const fetch_update_status = function* (action) {
    yield put({
        type: API.CAREERS.STATUS_UPDATE.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        let response = yield reqToAPI({
            url: `${API.CAREERS.STATUS_UPDATE.URL}`,
            method: "post",
            responseType: 'json',
            data: { ...action.payload },
            headers: {
        ...
        yield put({
            type: API.CAREERS.STATUS_UPDATE.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.CAREERS.STATUS_UPDATE.REJECTED,
            payload: errorObject.data
        });
    }
};
...
export const fetch_meta_details = function* (action) {
    yield put({
        type: API.CAREERS.META_DETAILS.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        let response = yield reqToAPI({
            url: `${API.CAREERS.META_DETAILS.URL}/${action.payload.id}`,
            method: "get",
            responseType: 'json',
            headers: {
                "content-type": "application/json",
        ...
        yield put({
            type: API.CAREERS.META_DETAILS.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.CAREERS.META_DETAILS.REJECTED,
            payload: errorObject.data
        });
    }
};
...
export const fetch_meta_update = function* (action) {
    yield put({
        type: API.CAREERS.META_UPDATE.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        let response = yield reqToAPI({
            url: `${API.CAREERS.META_UPDATE.URL}`,
            method: "post",
            responseType: 'json',
            data: formData,
            headers: { 'Authorization': `Bearer ${accessToken}`, 'Content-Type': 'multipart/form-data' }
        ...
        yield put({
            type: API.CAREERS.META_UPDATE.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.CAREERS.META_UPDATE.REJECTED,
            payload: errorObject.data
        });
    }
};
