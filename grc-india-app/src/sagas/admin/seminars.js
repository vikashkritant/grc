...
export const fetch_list = function* (action) {
    yield put({
        type: API.SEMINARS.LIST.PENDING
    });
    try {
        ...
        yield put({
            type: API.SEMINARS.LIST.FULLFILLED,
        ...
        yield put({
            type: API.SEMINARS.LIST.REJECTED,
...
export const fetch_add = function* (action) {
    ...
    try {
        ...
        formData.append("entry_type", action.payload.entry_type);
        ...
        yield put({
            type: API.SEMINARS.ADD.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.SEMINARS.ADD.REJECTED,
            payload: errorObject.data
        });
    }
};
...
export const fetch_details = function* (action) {
    yield put({
        type: API.SEMINARS.DETAILS.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        let response = yield reqToAPI({
            url: `${API.SEMINARS.DETAILS.URL}/${action.payload.id}`,
            method: "get",
            responseType: 'json',
            headers:{
                "content-type":"application/json",
        ...
        yield put({
            type: API.SEMINARS.DETAILS.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.SEMINARS.DETAILS.REJECTED,
            payload: errorObject.data
        });
    }
};
...
export const fetch_update = function* (action) {
    yield put({
        type: API.SEMINARS.UPDATE.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        yield put({
            type: API.SEMINARS.UPDATE.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.SEMINARS.UPDATE.REJECTED,
            payload: errorObject.data
        });
    }
};
...
export const fetch_update_status = function* (action) {
    yield put({
        type: API.SEMINARS.STATUS_UPDATE.PENDING
    });
    try {
        const state = yield select();
        const accessToken = state.Authentication_Reducers.accessToken;
        ...
        let response = yield reqToAPI({
            url: `${API.SEMINARS.STATUS_UPDATE.URL}`,
            method: "post",
            responseType: 'json',
            data: { ...action.payload },
            headers:{
        ...
        yield put({
            type: API.SEMINARS.STATUS_UPDATE.FULLFILLED,
            payload: response.data
        });
    } catch (error) {
        //console.log("error", { ...error });
        ...
        //console.log('error', error.message);
        yield put({
            type: API.SEMINARS.STATUS_UPDATE.REJECTED,
            payload: errorObject.data
        });
    }
};
