...
const AccreditationEdit = (props) => {
    ...
    useEffect(() => {
        dispatch(ACCREDITATIONS_ACTIONS.fetch_details(id));
    }, [id]);
    ...
    const { processing, error, errors, message, details, redirectTo } = useSelector(state => {
        return {
            ...
            details: state.Accreditations_Reducers.details,
    ...
    const submitForm = (e) => {
        ...
        if (!errorFound) {
            ...
            dispatch(ACCREDITATIONS_ACTIONS.fetch_update(pageFormFields));//add_upcoming_event
        }
                        ...
                        <Box component="form" noValidate sx={{ mt: 2, mx: 2, }}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} sm={12} sx={{ mt: 2 }}>
                                    ...
                                    File {details.file?<sub><a href={details.file} target="_blank">click here to download uploaded file</a></sub>:""}
                                    </Typography>
