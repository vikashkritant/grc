...
const ClienteleAdd = (props) => {
    ...
    const submitForm = (e) => {
        ...
        if (!errorFound) {
            ...
            dispatch(CLIENTELE_ACTIONS.fetch_add(pageFormFields));//add_upcoming_event
        }
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} sm={2}>
                                    <FormControl sx={{ minWidth: 120, marginTop: "12px" }} error={pageForm.display_on_homepageError ? true : false}>
                                        <InputLabel id="display_on_homepage-label">Display on Home</InputLabel>
                                        <Select
                                            margin="none"
                                            size="small"
