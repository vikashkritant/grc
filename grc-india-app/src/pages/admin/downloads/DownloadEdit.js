...
const DownloadEdit = (props) => {
    ...
    useEffect(() => {
        dispatch(DOWNLOAD_ACTIONS.fetch_details(id));
    }, [id]);
    ...
    const submitForm = (e) => {
        ...
        if (!errorFound) {
            ...
            dispatch(DOWNLOAD_ACTIONS.fetch_update(pageFormFields));//add_upcoming_event
        }
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} sm={12} sx={{ mt: 2 }}>
                                    <Typography component="h1" variant="body2">
                                        Thumbnail {details.file?<sub><a href={details.file} target="_blank">click here to download uploaded file</a></sub>:""}
                                    </Typography>
