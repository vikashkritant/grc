...
const DownloadMetaEdit = (props) => {
    ...
    useEffect(() => {
        dispatch(DOWNLOAD_ACTIONS.fetch_meta_details(1));
    }, []);
    ...
    const { processing, error, errors, message, details, redirectTo } = useSelector(state => {
        return {
            ...
            details: state.Downloads_Reducers.metaDetails,
    ...
    const submitForm = (e) => {
        ...
        if (!errorFound) {
            ...
            dispatch(DOWNLOAD_ACTIONS.fetch_meta_update(pageFormFields));//add_upcoming_event
        }
    ...
    return <Fragment>
        ...
        <Breadcrumbs aria-label="breadcrumb">
            ...
            >
                ...
                Downloads Page Meta Details Edit
            </Typography>
        </Breadcrumbs>
        <Box sx={{
            my: 3,
...
export default DownloadMetaEdit;