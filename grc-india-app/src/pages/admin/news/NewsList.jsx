...
const NewsList = (props) => {
    ...
    const { processing, error, errors, message, list, totalPages, total, redirectTo } = useSelector(state => {
        return {
            ...
            list: state.News_Reducers.list,
            totalPages: state.News_Reducers.totalPages,
            total: state.News_Reducers.total,
    ...
    useEffect(() => {
        dispatch(NEWS_ACTIONS.fetch_list(filter));
    ...
    const handleConfirmationModalSuccess = async (id, status) => {
        ...
        await dispatch(NEWS_ACTIONS.fetch_update_status(id, status));
        refreshList();
    };
    const refreshList = () => {
        dispatch(NEWS_ACTIONS.fetch_list(filter));
