...
const ContactUsMetaEdit = (props) => {
    ...
    useEffect(() => {
        dispatch(CONTACT_US_ACTIONS.fetch_meta_details(1));
    }, []);
    ...
    const { processing, error, errors, message, details, redirectTo } = useSelector(state => {
        return {
            ...
            details: state.ContactUs_Reducers.metaDetails,
    ...
    const submitForm = (e) => {
        ...
        if (!errorFound) {
            ...
            dispatch(CONTACT_US_ACTIONS.fetch_meta_update(pageFormFields));//add_upcoming_event
        }
    ...
    return <Fragment>
        ...
        <Breadcrumbs aria-label="breadcrumb">
            ...
            >
                ...
                Contact US Page Meta Details Edit
            </Typography>
        </Breadcrumbs>
        <Box sx={{
            my: 3,
                        ...
                        <Grid item xs={12} sm={5} sx={{ mt: 2 }}>
                            ...
                            <input accept="image/*" id="contained-button-file" type="file" ref={inputThumbnailFile} onChange={(e) => inputThumbnailFileChangeHandler(e)} style={{ display: "none" }} />
                            {
                                pageForm.thumbnail ? <Badge badgeContent={<CancelOutlinedIcon />} color="error" onClick={(e) => resetInputThumbnailFileChangeHandler(e)}>
                                    ...
                                    <img src={CONSTANTS.NO_IMAGE_BANNER_FOUND} alt={""} style={{ width: "130px", height: "130px" }} onClick={() => inputThumbnailFile.current.click()} />
                            }
...
export default ContactUsMetaEdit;