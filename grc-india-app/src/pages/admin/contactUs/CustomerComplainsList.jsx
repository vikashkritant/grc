...
const CustomerComplainsList = (props) => {
    ...
    const { processing, error, errors, message, list, totalPages, total, redirectTo } = useSelector(state => {
        return {
            ...
            list: state.ContactUs_Reducers.complains_list,
    ...
    useEffect(() => {
        dispatch(CONTACT_US_ACTIONS.fetch_customer_complains(filter));
                            ...
                            list.map((row, index) => (
                                ...
                                >
                                    ...
                                    <TableCell align="left">
                                        <NavLink to={`/admin/customer-complain/view/${row.id}`}>
...
export default CustomerComplainsList;