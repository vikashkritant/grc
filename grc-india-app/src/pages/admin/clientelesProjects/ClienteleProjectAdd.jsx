...
const ClienteleProjectAdd = (props) => {
    ...
    useEffect(() => {
        dispatch(CLIENTELE_ACTIONS.fetch_details(clientId));
    ...
    const { processing, errors, details, states, districts, sectors, projectTypes, redirectTo } = useSelector(state => {
        return {
            processing: state.Projects_Reducers.processing || state.Clienteles_Reducers.projects.processing || state.Utils_Reducers.states.processing || state.Utils_Reducers.sectors.processing || state.Utils_Reducers.project_types.processing,
    ...
    const submitForm = (e) => {
        ...
        if (!errorFound) {
            ...
            dispatch(CLIENTELE_ACTIONS.fetch_client_projects_create(pageFormFields));//add_upcoming_event
        }
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={3} sx={{ mt: 2 }}>
                                <Grid item xs={12} sm={12} sx={{ ml: 2 }}>
                                    ...
                                    {
                                        details.thumbnail ?
                                            <img src={details.thumbnail} alt={""} style={{ width: "100%", height: "150px" }} /> :
...
export default ClienteleProjectAdd;