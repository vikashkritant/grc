...
const ClienteleMetaEdit = (props) => {
    ...
    const onHomeContentChange = (e) => {
        setPageHomeContent(e);
    }
    ...
    useEffect(() => {
        ...
        if (details.title && !pageForm.dataLoaded) {
            ...
            onHomeContentChange(details.home_text);
        }
        return () => {
            setPageForm({
                ...pageForm,
            ...
            <Paper elevation={3}>
                <Box component="form" noValidate sx={{ mt: 2, mx: 2, }}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={12} id="page_home_text">
                            <Typography component="h1" variant="body2">
                                Home Page Content
                            </Typography>
                            <SummerNoteEditor pageContent={pageHomeContent} onContentChange={onHomeContentChange} />
                            <FormHelperText className="Mui-error"> {pageForm.home_textError}</FormHelperText>
                        </Grid>
