...
export const Events_Reducers = (state = initialState, action) => {
    switch (action.type) {

        case API.EVENTS.DETAILS.PENDING:
            ...
            return { ...state };
        case API.EVENTS.DETAILS.FULLFILLED:
            ...
            state.redirectTo = null;
            return { ...state };
        case API.EVENTS.DETAILS.REJECTED:
            state.processing = false;
            state.error = true;
            state.message = action.payload.message;
            state.details = {};
        ...
        case API.EVENTS.UPDATE.PENDING:
            state.processing = true;
            state.error = false;
            state.errors = [];
            state.message = "";
            state.redirectTo = null;
            return { ...state };
        case API.EVENTS.UPDATE.FULLFILLED:
            state.processing = false;
            state.error = false;
            state.errors = [];
            state.message = action.payload.message;
            ...
            return { ...state };
        case API.EVENTS.UPDATE.REJECTED:
            state.processing = false;
            state.error = true;
            state.message = action.payload.message;
            state.errors = action.payload.errors;
