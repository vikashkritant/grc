...
const list = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call frontend_workshops_seminars_conferences_fetch_list(${page},${itemPerPage},${order},${orderBy})`);
...
const details = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call frontend_workshops_seminars_conferences_fetch_details(${slug})`);
