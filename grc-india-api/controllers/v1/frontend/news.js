...
const list = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call frontend_news_fetch_list(${page},${itemPerPage},${order},${orderBy})`);
...
const details = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call frontend_news_fetch_details(${slug})`);
