...
const list = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_workshops_seminars_conferences_fetch_list(${status},${page},${itemPerPage},${order},${orderBy})`);
...
const details = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_workshops_seminars_conferences_fetch_details(${id})`);
...
const create = async (req, res, next) => {
    try {
        ...
        if (!fields.entry_type) {
            errors.entry_type = "this field is required!";
        } else {
        ...
        await runQuery(`call backend_workshops_seminars_conferences_create(${userId},${title},${slug},${short_content},${content},${banner},${thumbnail},${entry_type},${status},${meta_title},${meta_keywords},${meta_description},${display_order},${display_on_homepage})`);
...
const update = async (req, res, next) => {
    try {
        ...
        await runQuery(`call backend_workshops_seminars_conferences_update(${userId},${id},${title},${slug},${short_content},${content},${banner},${thumbnail},${entry_type},${status},${meta_title},${meta_keywords},${meta_description},${display_order},${display_on_homepage})`);
...
const update_status = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_workshops_seminars_conferences_update_status(${userId},${id},${status})`);
