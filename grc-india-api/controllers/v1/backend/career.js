...
const list = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_career_pages_fetch_list(${page},${itemPerPage},${order},${orderBy},${status})`);
...
const details = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_career_page_fetch_details(${id})`);
...
const create = async (req, res, next) => {
    try {
        ...
        await runQuery(`call backend_career_page_create(${userId},${title},${slug},${location},${short_content},${content},${banner},${status},${meta_title},${meta_keywords},${meta_description})`);
...
const update = async (req, res, next) => {
    try {
        ...
        await runQuery(`call backend_career_page_update(${userId},${id},${title},${slug},${location},${short_content},${content},${banner},${status},${meta_title},${meta_keywords},${meta_description})`);
...
const update_status = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_career_page_update_status(${userId},${id},${status})`);
...
const applications_list = async (req, res, next) => {
    try {
        const fields = req.query;
        // console.log(fields);
        let itemPerPage = 10;
        ...
        let result = await runQuery(`call backend_career_application_fetch_list(${careerId},${page},${itemPerPage},${order},${orderBy})`);
...
const applications_details = async (req, res, next) => {
    try {
        const fields = req.params;
        let id = null;
        ...
        let result = await runQuery(`call backend_career_application_fetch_details(${id})`);
...
const page_meta_details = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_career_page_seo_fetch_details(${id})`);
        let pageDetails = result[0][0];
...
const page_meta_update = async (req, res, next) => {
    try {
        ...
        await runQuery(`call backend_career_page_seo_update(${userId},${id},${title},${slug},${banner},${meta_title},${meta_keywords},${meta_description})`);
