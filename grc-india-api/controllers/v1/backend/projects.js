...
const list = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_projects_fetch_list(${status},${page},${itemPerPage},${order},${orderBy})`);
...
const details = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_projects_fetch_details(${id})`);
...
const create = async (req, res, next) => {
    try {
        ...
        await runQuery(`call backend_projects_create(${userId},${title},${slug},${content},${banner},${state},${status},${meta_title},${meta_keywords},${meta_description})`);
...
const update = async (req, res, next) => {
    try {
        ...
        await runQuery(`call backend_projects_update(${userId},${id},${title},${slug},${content},${banner},${state},${status},${meta_title},${meta_keywords},${meta_description})`);
...
const update_status = async (req, res, next) => {
    try {
        ...
        let result = await runQuery(`call backend_projects_update_status(${userId},${id},${status})`);
